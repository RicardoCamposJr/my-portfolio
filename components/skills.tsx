      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            <span className="text-primary">&lt;</span> Tecnologias <span className="text-primary">/&gt;</span>
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto">
            Estas são as principais tecnologias e ferramentas que utilizo para criar aplicações web modernas, escaláveis
